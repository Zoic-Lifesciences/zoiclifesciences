  ...
  return (
    <section className="px-8 py-12">
      ...
      <p className="text-center text-gray-500 mb-8">
        At <span className="text-[#03045E] font-semibold">ZOIC</span> it’s all about continuous innovations.
      </p>

      <div className="flex overflow-x-auto space-x-10 ml-10 scrollbar-hide">
        {products.map((p) => (
          <div
            key={p.id}
            className=" h-[60vh] w-[300px] flex-shrink-0 bg-white shadow-xl border border-gray-200 rounded-t-[50%]"
          >
            <div
