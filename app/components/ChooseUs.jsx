  ...
  return (
    ...
    >
      <div className="flex flex-col md:w-[70%] w-[80%] h-full">
        <h2 className="regulator-nova-alts-straight tracking-wider md:text-6xl text-5xl text-white mb-12 text-center font-bold">
          Why Choose Us?
        </h2>
            ...
            {items.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <h3 className="regulator-nova-alts-straight tracking-wider font-semibold text-3xl text-gray-900">
                      {item.title}
                    </h3>
